...
if (isFALSE(table(c("not spicy", "a bit spicy", "mildly spicy", "very spicy", "Waw! Fire!") == levels(grades)) == 5)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE((ncol(df) == 2) & (ncol(df1) == 10))) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
