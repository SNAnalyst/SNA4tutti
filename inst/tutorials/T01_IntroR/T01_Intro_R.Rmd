...
# no packages needed for tutorial one since everything is in R base

# RStudio, at least 2022.2.2.485
check_RStudio <- sna4tutti:::check_rstudio


# R check version (required 4.2.0) -updated June 2022
check_R <- function(x) {
  sna4tutti:::check_r_equal(4, 2.0)
}
...
You need to have installed `r rproj()` version 4.2.0 (or higher) and this tutorial
...
You need to have installed RStudio version 2022.02.3+492 or above. Let's
