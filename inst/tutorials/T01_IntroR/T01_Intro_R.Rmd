...
You need to have installed at least R version 4.2.1 and this tutorial is going to check
...
You need to have installed RStudio version 2022.7.1.554 or above. Let's
...
expression to the very first part of tje right-hand side expression. 
This is a bit
...
That was quick, right? What happens is that *R* inserts *iris* as the very 
...
![](images/depositphotos_64130295-stock-illustration-ninja-mascot.jpg)
