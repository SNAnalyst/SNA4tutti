...
Even if our terms are significant in models two and three, they are not anymore when we combine them. Also, the AIC and BIC are higher than the ones in model 3.
