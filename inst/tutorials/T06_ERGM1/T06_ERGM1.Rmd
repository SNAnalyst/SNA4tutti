...
![](images/cavalcata-dei-re-magi-si-trova-sulla-parete-sinistra-della-cappella-dei-magi-in-palazzo-medici-riccardi-a-firenze-ed-e-opera-di-benozzo-gozzoli_3ff44f8f_1.jpg){width=75%}
...
if (isFALSE(table((network::get.vertex.attribute(florentine, 'vertex.names')) == c("Acciaiuoli", "Albizzi", "Barbadori", "Bischeri", "Castellani", "Ginori", "Guadagni", "Lamberteschi", "Medici", "Pazzi", "Peruzzi",       "Pucci", "Ridolfi", "Salviati", "Strozzi", "Tornabuoni")) == 16)) {
...
if (isFALSE(network::get.vertex.attribute(florentine, 'NumberPriorates')[2] == 65)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(network::get.vertex.attribute(florentine, 'NumberTies')[16] == 7)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(network::get.vertex.attribute(florentine, 'Wealth')[9] == 103)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(length(network::get.edge.attribute(florentine, 'weight')) == 20)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(network::get.vertex.attribute(sampson, 'like1')[16] == "T")) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(sum(network::get.edge.attribute(sampson, 'weight')) == 110)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
