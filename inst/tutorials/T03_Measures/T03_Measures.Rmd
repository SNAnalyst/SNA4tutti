...
You need to have installed a recent version of RStudio version 2022.7.1.554 or above.
...
(hint: it may be helpful to consider the graph in terms of its adjacency matrix...)
...
The stress on a vertex is a relevant measure in physical networks (e.g., networks 
