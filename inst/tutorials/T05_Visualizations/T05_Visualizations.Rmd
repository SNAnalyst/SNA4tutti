...
learnr::quiz(learnr::question("What is the main problem with the plots of igraphNet and igraphNetLarge?",
...
q1 <- learnr::quiz(learnr::question("WWhat is the main problem with the plots of igraphNet and igraphNetLarge?",
                    learnr::answer("nodes are too small"),
                    learnr::answer("the colors are not color blind friendly"),
                    learnr::answer("the plot does not inform us on what the network represents", correct = TRUE),
                    correct = "Yes! Well done!",
...
if (base::isFALSE(q1$questions[[1]]$question == "What is the main problem with the plots of igraphNet and igraphNetLarge?")) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- base::append(errors, error)
}
