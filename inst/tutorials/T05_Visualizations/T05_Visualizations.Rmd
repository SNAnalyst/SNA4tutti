...
if (as.character(table(y2 == c(2, 8, 18, 32, 50, 72, 98, 128, 162, 200))) != "10") {
...
quiz(question("What is the main problem with the plots of igraphNet and networkNet?",
...
if (q1$questions[[1]]$question != "What is the main problem with the plots of igraphNet and networkNet?") {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(as.vector(table(igraph::V(net)$gender))[2] == 51)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(as.vector(table(igraph::E(net)$frequency))[2] == 37)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(as.vector(table(igraph::E(net)$closeness))[5] == 1)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
quiz(question("How do you interpret this visualization?",
...
q1 <- learnr::quiz(question("How do you interpret this visualization?",
    answer("The year matters for friednship formation but the gender does not"),
    answer("Both matter, but since there are many more males the year is a better predictor of friendship", correct = TRUE),
    answer("The year does not matter for friendship formation but the gender does"),
    answer("Both the year and the gender equally matter in predicting friendship"),
...
if (q1$questions[[1]]$question != "How do you interpret this visualization?") {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
# test correct answer
q1in <- question("How do you interpret this visualization?",
    answer("The year matters for friednship formation but the gender does not"),
    answer("Both matter, but since there are many more males the year is a better predictor of friendship", correct = TRUE),
    answer("The year does not matter for friendship formation but the gender does"),
    answer("Both the year and the gender equally matter in predicting friendship"),
