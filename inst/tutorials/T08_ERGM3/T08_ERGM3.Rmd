...
# R check version (required 4.2.0)
check_R <- function(x) {
...
Here a fun fact for you. The `ergm` developers included a typo in the package. So we are going to code an attribute named _"bipratite"_. The typo attribute needs to have the same dimension as the first partition. So in our case, it will be 10.
...
# snafun::plot_weighted_graph(lending_2005, seed = 123, 
...
_NOTE:_
I inserted a burn-in of 1000 and simulated 10000 networks. I used this set up to speed up computation within the tutorial. You will need to increase these numbers to something like 10k and 40k (or more) when you will use these models for real!
