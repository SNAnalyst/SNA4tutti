...
if (isFALSE(sum(network::get.vertex.attribute(mesa, 'Grade')) == 1790 )) {
...
if (isFALSE(table(network::get.vertex.attribute(mesa, 'Race'))[2] == 109 & table(network::get.vertex.attribute(mesa, 'Race'))[3] == 68 )) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(table(network::get.vertex.attribute(mesa, 'Sex'))[1] == 99 & 
            table(network::get.vertex.attribute(mesa, 'Sex'))[2] == 106)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(table((network::get.vertex.attribute(flobusiness, 'vertex.names')) == c("Acciaiuoli", "Albizzi", "Barbadori", "Bischeri", "Castellani", "Ginori", "Guadagni", "Lamberteschi", "Medici", "Pazzi", "Peruzzi",       "Pucci", "Ridolfi", "Salviati", "Strozzi", "Tornabuoni")) == 16)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(network::get.vertex.attribute(flobusiness, 'NumberPriorates')[2] == 65)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(sum(network::get.vertex.attribute(flobusiness, 'NumberTies')) == 222)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(network::get.vertex.attribute(flobusiness, 'Wealth')[9] == 103)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(sum(as.numeric(network::get.vertex.attribute(magnolia, 'vertex.names'))) == 1067991)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(table(network::get.vertex.attribute(magnolia, 'Grade'))[2] == 210 &
            table(network::get.vertex.attribute(magnolia, 'Grade'))[3] == 317 &
            table(network::get.vertex.attribute(magnolia, 'Grade'))[6] == 193)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(table(network::get.vertex.attribute(magnolia, 'Race'))[1] == 48  &
            table(network::get.vertex.attribute(magnolia, 'Race'))[2] == 261 &
            table(network::get.vertex.attribute(magnolia, 'Race'))[3] == 68  &
            table(network::get.vertex.attribute(magnolia, 'Race'))[4] == 24  &
            table(network::get.vertex.attribute(magnolia, 'Race'))[5] == 7   &
            table(network::get.vertex.attribute(magnolia, 'Race'))[6] == 1053)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(table(network::get.vertex.attribute(magnolia, 'Sex'))[1] == 768 &
            table(network::get.vertex.attribute(magnolia, 'Sex'))[2] == 693)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(table((network::get.vertex.attribute(sampson, 'vertex.names')) == 
...
if (isFALSE(network::get.vertex.attribute(sampson, 'id')[2] == "0x2112a4aae00")) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(network::get.vertex.attribute(sampson, 'like2')[16] == "T")) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(sum(network::get.edge.attribute(sampson, 'weight')) == 111)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(igraph::get.graph.attribute(UKF, 'Type') == "TSPE" &
...
if (isFALSE(sum(igraph::get.vertex.attribute(UKF, 'Group')) == 152)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
...
if (isFALSE(sum(igraph::get.edge.attribute(UKF, 'weight')) == 3730)) {
  sna4tutti::broken_info()
  error <- knitr::opts_current$get(name = "label")
  errors <- append(errors, error)
}
